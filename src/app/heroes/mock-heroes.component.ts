...
export const HEROES: Hero[] = [
    new Hero(1, "Ger", 99, "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/149.png", ['Dragon']),
    new Hero(2, "K", 85, "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/005.png", ['Feu', 'Eau',]),
    new Hero(3, "Minou", 75, "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/053.png", ['Normal']),
    new Hero(4, "Momo", 65, "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/188.png", ['Plante', 'Poison']),
    new Hero(5, "Aurel", 58, "https://assets.pokemon.com/assets/cms2/img/pokedex/detail/010.png", ['Insecte']),
